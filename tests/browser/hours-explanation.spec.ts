...
function response(){
 ...
 return {routes:samples.map(r=>({...r,source:'geoapify',geometryKind:'provider'})),analyses,comparison:{...result.comparison,scores:{},recommendedId:null,outcome:'insufficient'},checkedAt:TUTORIAL_CHECKED_AT,activityStatus:'partial',notices:[],attributions:[],usage:{remainingComparisons:1}};
}
