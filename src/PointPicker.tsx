...
export function PointPicker({ value, onChoose, anchor, direction }: { value: JourneyPoint; onChoose: (point: JourneyPoint) => void; anchor:JourneyPoint; direction:SearchDirection }) {
  ...
  return <><p className="sheet-intro">Search near your journey endpoint in North Bengaluru or Kanpur. Ordinary streets and neighbourhoods are supported too.</p>
    <PlaceSearch onChoose={onChoose} anchor={anchor} direction={direction}/>
    <Favourites point={value} onChoose={onChoose}/>
