...
export function PointPicker({ value, onChoose, accessCode='', anchor, direction }: { value: JourneyPoint; onChoose: (point: JourneyPoint) => void; accessCode?:string; anchor:JourneyPoint; direction:SearchDirection }) {
  ...
  return <><p className="sheet-intro">Search near your journey endpoint in North Bengaluru or Kanpur. Ordinary streets and neighbourhoods are supported too.</p>
    <PlaceSearch onChoose={onChoose} accessCode={accessCode} anchor={anchor} direction={direction}/>
