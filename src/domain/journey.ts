...
export function regionForPoint(p:Coordinate){return p&&Number.isFinite(p.latitude)&&Number.isFinite(p.longitude)?SERVICE_REGIONS.find(r=>distanceMeters(r.center,p)<=r.radiusMeters):undefined;}
