...
export type PlaceObservation = { id: string; name?: string; coordinate: Coordinate; categories: string[]; hours?: OpeningHours; hoursOrigin?: 'google-regular'; businessStatus?: string; schedule?: PlaceSchedule; currentScheduleInvalid?: boolean; calendarHours?: { alwaysOpen?: boolean; from: string; until: string; periods: { from: string; until: string }[] }; currentHours?: { openNow: boolean; nextOpenTime?: string; nextCloseTime?: string; observedAt: string }; observedAt: string };
