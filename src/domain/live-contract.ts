...
export type ServiceStatus = { ready: boolean; configured?:boolean; paused?:boolean; searchEnabled?:boolean; searchPreviewEnabled?:boolean; activityEnabled: boolean; scoringEnabled: boolean; accessCodeRequired?: false; maxQueries: number };
