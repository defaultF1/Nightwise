...
// The compact card variant keeps the band and its collapsed explainer; the
// full variant adds the legend for the evidence sheet.
export function ActivityStrip({analysis,compact=false}:{analysis:ActivityAnalysis;compact?:boolean}){
  ...
  return <div className="activity-strip">
    ...
    {!compact&&<div className="segment-legend"><span><i className="active"/> Open places</span><span><i className="low"/> Few open places</span><span><i className="unknown"/> Not enough data</span></div>}
