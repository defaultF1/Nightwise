...
export function HelpPoints({analysis}:{analysis?:ActivityAnalysis}){
  ...
  return <section className="help-points"><h3>Help points along this route</h3><p>Open or estimated open when you pass. Check the status below.</p>{analysis.longestObservedHelpGapMeters>0&&<p>Longest gap without a Google-listed open help point (excludes estimates): <strong>{formatMeters(analysis.longestObservedHelpGapMeters)}</strong></p>}
