...
const env={...process.env,VITE_MAP_PROVIDER:'geoapify',VITE_HOSTED_TEAM:'',VITE_API_BASE_URL:'',VITE_ANDROID_API_BASE_URL:'',VITE_GOOGLE_MAPS_KEY:'',VITE_ENABLE_LIVE_MAPS:'false'};
