...
assert fields['name']=='in.nightwise.demo' and fields['versionName']=='0.7.6-preview' and fields['versionCode']=='16'
...
target=root/'output/apk/nightwise-0.7.6-debug.apk'
