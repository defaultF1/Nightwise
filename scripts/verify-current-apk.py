...
assert fields['name']=='in.nightwise.demo' and fields['versionName']=='0.7.3-preview' and fields['versionCode']=='13'
...
target=root/'output/apk/nightwise-0.7.3-debug.apk'
...
record={'file':target.name,'sizeBytes':target.stat().st_size,'sha256':digest,'packageId':fields['name'],'versionName':fields['versionName'],'versionCode':13,'signatureVerified':True,'webAssetsMatch':True,'serverKeyAbsent':True,'backgroundLocationPermission':False,'physicalPhoneTested':False,'googleCloudLiveTested':False}
(target.parent/'nightwise-0.7.3-verification.json').write_text(json.dumps(record,indent=2),encoding='utf-8')
