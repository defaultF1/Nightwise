...
assert fields['name']=='in.nightwise.demo' and fields['versionName']=='0.6.3-prebilling' and fields['versionCode']=='9'
...
target=root/'output/apk/nightwise-0.6.3-debug.apk'
...
record={'file':target.name,'sizeBytes':target.stat().st_size,'sha256':digest,'packageId':fields['name'],'versionName':fields['versionName'],'versionCode':9,'signatureVerified':True,'webAssetsMatch':True,'serverKeyAbsent':True,'backgroundLocationPermission':False,'physicalPhoneTested':False,'googleCloudLiveTested':False}
(target.parent/'nightwise-0.6.3-verification.json').write_text(json.dumps(record,indent=2),encoding='utf-8')
